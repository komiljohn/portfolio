...
export default function Education() {
  return (
    <section className="container mx-auto px-4 pt-[60px] pb-10 text-center">
      ...
      <FadeInWhenVisible
        delay={0.3}
        className="flex justify-between text-sm max-sm:flex-col max-sm:items-start"
      >
        ...
        <p className="text-text-secondary-light dark:text-text-secondary-dark max-sm:pl-12">
          2018 - 2022
        </p>
      </FadeInWhenVisible>
    </section>
